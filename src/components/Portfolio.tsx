          ...
          <div className="mb-20">
            ...
            <div className="mb-16 reveal">
              <div className="relative group">
                ...
                <Card className="relative overflow-hidden border border-white/10 bg-gradient-to-br from-slate-800/50 via-purple-900/30 to-indigo-900/50 backdrop-blur-xl">
              ...
              {aiAutomationProjects.map((project, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Card className={`relative h-full border border-white/10 bg-gradient-to-br from-slate-800/80 via-purple-900/40 to-indigo-900/60 backdrop-blur-xl transition-all duration-700 group overflow-hidden ${
