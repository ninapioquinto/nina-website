  ...
  return <section id="case-study" ref={sectionRef} className="py-24 relative">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-lg text-white/70 mb-16 max-w-2xl mx-auto reveal">How an HVAC Company Increased Bookings by 10+ Per Month After a CRM Rebuild</p>
