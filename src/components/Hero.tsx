...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center pt-16 sm:pt-20 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-16 h-16 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-purple-500/20 to-violet-600/10 blur-xl animate-float" style={{ animationDelay: '0s' }}></div>
      <div className="absolute bottom-1/4 right-1/3 w-20 h-20 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-indigo-500/20 to-purple-600/10 blur-xl animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute top-1/2 right-1/4 w-12 h-12 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-violet-500/20 to-purple-600/10 blur-xl animate-float" style={{ animationDelay: '2s' }}></div>

      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Luxury typography with elegant gradients */}
          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight tracking-tighter">
            ...
            <span className="relative inline-block mx-1 sm:mx-2 min-w-[120px] sm:min-w-[180px] h-[40px] sm:h-[60px]">
              <span 
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/80 mb-6 sm:mb-8 lg:mb-10 max-w-2xl mx-auto leading-relaxed px-4">
          ...
          <Button 
            ...
            size="lg" 
            className="luxury-button text-base sm:text-lg px-6 sm:px-8 lg:px-10 py-4 sm:py-5 lg:py-6 bg-gradient-to-r from-purple-600/20 via-violet-600/20 to-indigo-600/20 
          ...
          >
            ...
            <span className="relative z-10 flex items-center">
              Explore My Work 
              <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-500 group-hover:translate-x-2 group-hover:scale-110" />
            </span>
          </Button>
          
          {/* Elegant scroll indicator */}
          <div className="mt-12 sm:mt-16 lg:mt-20 flex justify-center">
            <div className="luxury-scroll-indicator w-5 h-10 sm:w-6 sm:h-12 border-2 border-purple-400/40 rounded-full flex justify-center backdrop-blur-sm">
              <div className="w-0.5 sm:w-1 h-2 sm:h-3 bg-gradient-to-b from-purple-400 to-violet-500 rounded-full mt-1.5 sm:mt-2 animate-bounce"></div>
            </div>
          </div>
        </div>
      </div>
