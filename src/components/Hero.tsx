  ...
  return <section className="min-h-screen flex items-center pt-16 sm:pt-20 relative overflow-hidden px-4 sm:px-0">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">App Development • AI Automation • CRM Systems</p>
          
          {/* Updated CTA button */}
          <Button onClick={handleScrollToContact} size="lg" className="luxury-button text-base sm:text-lg px-6 sm:px-10 py-4 sm:py-6 bg-gradient-to-r from-purple-600/20 via-violet-600/20 to-indigo-600/20 
