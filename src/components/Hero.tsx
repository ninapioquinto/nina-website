    ...
    <section className="min-h-screen flex items-center pt-16 sm:pt-20 relative overflow-hidden px-4 sm:px-0">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Hero headline with focus on clarity, performance, and scale */}
          <div className="relative inline-block mb-4 sm:mb-6">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight tracking-tighter text-white mb-6">
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-300/90 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
          ...
          <Button 
            ...
            size="lg" 
            className="luxury-button text-base sm:text-lg px-6 sm:px-10 py-4 sm:py-6 bg-gradient-to-r from-navy-700/30 via-navy-600/30 to-navy-800/30 
