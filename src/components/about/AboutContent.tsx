    ...
    <div className="reveal space-y-16">
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
            <div className="flex-shrink-0">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-navy-500/30 to-navy-600/30 border-2 border-navy-400/40 flex items-center justify-center shadow-2xl">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-navy-400/90 to-accent-gold/90 flex items-center justify-center">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="h-1 w-20 bg-gradient-to-r from-navy-400 to-accent-gold rounded-full mb-6 mx-auto lg:mx-0"></div>
          ...
          <div className="space-y-4">
            {process.map((step, index) => (
              <div key={index} className="flex items-start gap-4 group">
                <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-br from-navy-500/30 to-accent-gold/30 rounded-full border border-navy-400/40 flex items-center justify-center text-sm font-bold text-navy-300 group-hover:scale-110 transition-transform duration-200">
                  {index + 1}
                </div>
      ...
      <div className="space-y-8">
        <div className="text-center">
          ...
          <div className="h-1 w-16 bg-gradient-to-r from-navy-400 to-accent-gold rounded-full mx-auto"></div>
        </div>
              ...
              <div key={index} className="group">
                <div className="bg-gradient-to-br from-slate-800/60 via-navy-900/30 to-navy-800/40 backdrop-blur-xl rounded-2xl border border-white/20 p-8 h-full transition-all duration-300 group-hover:border-navy-400/40 group-hover:bg-white/5 group-hover:transform group-hover:scale-105">
                  <div className="flex flex-col items-center text-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-navy-500/30 to-accent-gold/30 rounded-2xl border border-navy-400/40 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
