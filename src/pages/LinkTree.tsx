...
const TiktokIcon = (props: React.SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md flex flex-col items-center gap-7 p-8 rounded-3xl bg-violet-950/30 border border-violet-400/20 shadow-xl backdrop-blur-lg animate-glow">
          ...
          <div className="text-center">
            ...
            <span className="block text-sm mt-1 tracking-wide text-neutral-400">Bespoke CRM &amp; AI Automation Systems</span>
          </div>
          {/* Socials row */}
          <div className="flex flex-row gap-8 mt-1 mb-1">
            {/* Instagram */}
            <a href="https://www.instagram.com/automationcrmexpert" target="_blank" rel="noopener noreferrer" className="text-violet-400 hover:text-violet-200 hover:scale-110 transition-all duration-300" aria-label="Instagram">
              <Instagram className="w-7 h-7" />
            </a>
            {/* TikTok */}
            <a href="https://www.tiktok.com/@automationcrmexpert" target="_blank" rel="noopener noreferrer" className="text-violet-400 hover:text-violet-200 hover:scale-110 transition-all duration-300" aria-label="TikTok">
              <TiktokIcon className="w-7 h-7" />
            </a>
            {/* GitHub */}
            <a href="https://github.com/ninapioquinto" target="_blank" rel="noopener noreferrer" className="text-violet-400 hover:text-violet-200 hover:scale-110 transition-all duration-300" aria-label="GitHub">
