      ...
      <div className="relative z-10">
        <div className="min-h-screen">
            ...
            <div className="container mx-auto px-4 relative">
              <div className="max-w-5xl mx-auto">
                <div className="text-center mb-20">
                  <div className="inline-flex items-center gap-3 bg-white/5 backdrop-blur-xl border border-white/10 rounded-full px-6 py-3 mb-8 shadow-lg shadow-purple-500/20 glow-border">
                  ...
                  <div className="bg-gradient-to-r from-purple-500/10 via-violet-500/5 to-indigo-500/10 backdrop-blur-xl border border-purple-500/20 rounded-3xl p-12 mb-16 shadow-2xl shadow-purple-500/10 glow-border">
                  ...
                  <p className="text-xl text-white/80 mb-12">Let's break it down:</p>
                </div>
                
                {/* Pain Points - Modern Layout */}
                <div className="grid md:grid-cols-3 gap-12 mb-20">
                  <div className="text-center group">
                    <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-purple-500 to-violet-500 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/25 transition-all duration-300 group-hover:scale-110 group-hover:shadow-purple-500/40">
                  ...
                  <div className="text-center group">
                    <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-violet-500 to-indigo-500 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/25 transition-all duration-300 group-hover:scale-110 group-hover:shadow-violet-500/40">
                  ...
                  <div className="text-center group">
                    <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-500/25 transition-all duration-300 group-hover:scale-110 group-hover:shadow-indigo-500/40">
          ...
          <section className="py-32 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-900/10 via-violet-900/5 to-indigo-900/10"></div>
            <div className="container mx-auto px-4 relative">
              <div className="max-w-5xl mx-auto">
                <div className="text-center mb-20">
                  <div className="inline-flex items-center gap-3 bg-purple-500/10 backdrop-blur-xl border border-purple-500/20 rounded-full px-6 py-3 mb-8 shadow-lg shadow-purple-500/20 glow-border">
                    <Rocket className="w-5 h-5 text-purple-400" />
                    <span className="text-purple-300 font-medium">The Solution</span>
                  </div>
                  
                  <h2 className="text-4xl md:text-6xl font-bold mb-8 bg-gradient-to-r from-purple-400 via-violet-300 to-indigo-400 bg-clip-text text-transparent">
                ...
                <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl p-12 shadow-2xl shadow-purple-500/10 glow-border">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="flex items-start gap-6 group">
                      <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-violet-500 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-purple-500/25">
                    ...
                    <div className="flex items-start gap-6 group">
                      <div className="w-12 h-12 bg-gradient-to-r from-violet-500 to-indigo-500 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-violet-500/25">
                    ...
                    <div className="flex items-start gap-6 group">
                      <div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-indigo-500/25">
                  ...
                  <div className="mt-12 p-8 bg-gradient-to-r from-purple-500/10 to-violet-500/10 rounded-2xl border border-purple-500/20 shadow-lg shadow-purple-500/10 glow-border">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {[
                    ...
                    <div key={index} className="bg-white/5 backdrop-blur-2xl border border-white/20 rounded-3xl p-8 hover:bg-white/10 transition-all duration-500 hover:scale-105 shadow-2xl shadow-purple-500/10 glow-border">
          ...
          <section className="py-32 relative">
            ...
            <div className="container mx-auto px-4 relative">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl border border-white/20 rounded-3xl p-16 shadow-2xl shadow-purple-500/20 glow-border">
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-12 mb-12">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-gradient-to-r from-purple-400 to-violet-400 rounded-full flex items-center justify-center shadow-lg shadow-purple-500/25">
                        <Clock className="text-white" size={20} />
                      </div>
                      <span className="text-white/90 text-xl">Delivered in 72 hours</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-gradient-to-r from-violet-400 to-indigo-400 rounded-full flex items-center justify-center shadow-lg shadow-violet-500/25">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <div className="relative">
                  ...
                  <div className="relative p-16 rounded-3xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 backdrop-blur-2xl shadow-2xl shadow-purple-500/20 glow-border">
                    <h2 className="text-4xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-white via-purple-200 to-violet-300 bg-clip-text text-transparent">
                    ...
                    <div className="bg-gradient-to-r from-purple-500/10 to-violet-500/10 border border-purple-500/30 rounded-2xl p-8 mb-12 backdrop-blur-sm shadow-lg shadow-purple-500/10 glow-border">
                      <div className="flex items-center justify-center gap-3 mb-3">
                        <Shield className="text-purple-400" size={24} />
                        <p className="text-xl font-bold text-purple-400">Limited Availability</p>
                      </div>
